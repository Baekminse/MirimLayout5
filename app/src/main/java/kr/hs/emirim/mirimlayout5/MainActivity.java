...
import kr.hs.emirim.mirimlayout5.R;

public class MainActivity extends AppCompatActivity {
    int[] btnId = {R.id.btn_0, R.id.btn_1,R.id.btn_0, R.id.btn_1,R.id.btn_2, R.id.btn_3,R.id.btn_4, R.id.btn_5,R.id.btn_6, R.id.btn_7,R.id.btn_8, R.id.btn_9};
    ...
    View.OnClickListener btnNListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if(edit1.isFocused() == true){
                ...
                num2 = edit1.getText().toString() + btn.getText().toString();
                edit1.setText(num2);
            }else{
